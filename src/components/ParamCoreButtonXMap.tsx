...
export function ParamCoreButtonXMap({param_const, params_ref, defpar_ref, dummy_state}: {
  ...
  return (
    ...
    <div className="inline-block">
      ...
      <div className="flex max-w-md flex-col gap-0" id="button_form_fields">
        {
          Object.entries(BUTTON_PATTERNS).map( ([key, option]: [string, {desc: string, }])  => {
            return (
              ...
              <div className="pb-1" key={key}>
                ...
                >
                  {
                    Object.entries(BUTTON_ACTIONS).map( ([option_key, option]: [string, {desc: string, val: number}])  => {
                      return (
