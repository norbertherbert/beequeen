...
export function PramLorawanS1TxStrategy({
  param_const,
  params_ref,
  defpar_ref,
  dummy_state,
  ...
  const [state, set_state] = useState<
    Lorawan_s1_tx_strategy_gui_val | undefined
  >();
  ...
  return (
    <div className="inline-block">
      ...
      <Label htmlFor="first_tr">
        Enabled data rates for the first transmission
      </Label>

      <div className="mb-1 flex items-center justify-start" id="first_tr">
        {Object.entries(LORAWAN_TX_STRATEGY_BITS)
      ...
      <Label htmlFor="second_tr">
        Enabled data rates for the second transmission
      </Label>

      <div className="mb-1 flex items-center justify-start" id="second_tr">
        {Object.entries(LORAWAN_TX_STRATEGY_BITS)
